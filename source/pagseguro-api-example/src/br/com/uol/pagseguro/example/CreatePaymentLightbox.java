...
public class CreatePaymentLightbox {
    ...
    public static void main(String[] args) {
        ...
        paymentRequest.addItem("0001", "Notebook Prata", new Integer(1), new BigDecimal("2430.00"), new Long(1000),
                null);
        ...
        paymentRequest.setSender("Joao Comprador", "comprador@uol.com.br", "11", "56273440");

        paymentRequest.addSenderDocument("CPF", "123.456.789-09");
        ...
        try {
            ...
            String code = paymentRequest.register(new AccountCredentials("vendedor@java.com",
                    "00000000000000000000000000000000"), onlyCheckoutCode);

            // String paymentURL = paymentRequest.register(PagSeguroConfig.getAccountCredentials(),
            // PagSeguroConfig.getCheckoutLightbox());
