...
public class CreatePaymentLightbox {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Boolean isCheckoutLightbox = true;
            
            String paymentURL = paymentRequest.register(
                    new AccountCredentials("suporte@lojamodelo.com.br", "00000000000000000000000000000000"), isCheckoutLightbox);

//          String paymentURL = paymentRequest.register(PagSeguroConfig.getAccountCredentials(), PagSeguroConfig.getCheckoutLightbox());
