...
public class CreatePayment {
    ...
    public static void main(String[] args) {
        ...
        paymentRequest.addSenderDocument("CPF", "000.000.001-91");
        ...
        paymentRequest.addParameter("redirectURL", "http://www.meusite.com.br/redir");
        ...
        try {
            ...
            String paymentURL = paymentRequest.register(new AccountCredentials("vendedor@java.com",
